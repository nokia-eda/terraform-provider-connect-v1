---
page_title: "connect-v1 Provider"
---

# connect-v1 Provider

This provider is used to interact with the resources provided by the **connect-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
