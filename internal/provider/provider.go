...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-connect/internal/eda/utils"
...
var _ provider.Provider = (*connectProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &connectProvider{version: ver}
	}
}
...
func (p *connectProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *connectProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *connectProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "connect-v1"
	resp.Version = p.version
}

func (p *connectProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewConnectAuditDataSource,
		NewConnectAuditListDataSource,
		NewConnectInterfaceDataSource,
		NewConnectInterfaceListDataSource,
		NewConnectPluginDataSource,
		NewConnectPluginActionableDataSource,
		NewConnectPluginActionableListDataSource,
		NewConnectPluginListDataSource,
		NewResourceListDataSource,
	}
}

func (p *connectProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewConnectAuditResource,
		NewConnectInterfaceResource,
		NewConnectPluginResource,
		NewConnectPluginActionableResource,
	}
}
