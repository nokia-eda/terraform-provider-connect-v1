...
package resource_connect_plugin
...
func ConnectPluginResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ConnectPlugin$"), ""),
				},
				Default: stringdefault.StaticString("ConnectPlugin"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ConnectPlugin",
				MarkdownDescription: "name of the ConnectPlugin",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"heartbeat_interval": schema.Int64Attribute{
						Optional:            true,
						Description:         "HeartbeatInterval indicates in seconds the interval in which the Plugin will heartbeat.\nWhen the interval is 0, heartbeating will be disabled.",
						MarkdownDescription: "HeartbeatInterval indicates in seconds the interval in which the Plugin will heartbeat.\nWhen the interval is 0, heartbeating will be disabled.",
					},
					"name": schema.StringAttribute{
						Required:            true,
						Description:         "Name is a human-readable representation of the Plugin.",
						MarkdownDescription: "Name is a human-readable representation of the Plugin.",
					},
					"plugin_type": schema.StringAttribute{
						Required:            true,
						Description:         "PluginType identifies the type of the Plugin. Eg. VMware, OpenStack.",
						MarkdownDescription: "PluginType identifies the type of the Plugin. Eg. VMware, OpenStack.",
					},
					"required_plugins": schema.ListAttribute{
						ElementType:         types.StringType,
						Optional:            true,
						Description:         "A list of ConnectPlugins whose resources this ConnectPlugin will require",
						MarkdownDescription: "A list of ConnectPlugins whose resources this ConnectPlugin will require",
					},
					"supported_actionables": schema.ListAttribute{
						ElementType:         types.StringType,
						Optional:            true,
						Description:         "SupportedActionables is a List of Actionable identifiers that this Plugin supports.",
						MarkdownDescription: "SupportedActionables is a List of Actionable identifiers that this Plugin supports.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"stale": schema.BoolAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "When a plugin registers with a certain heartbeatinterval and it does not meet that contract, Connect will assume\nthat the plugin is Stale / non-responsive. An alarm is raised when the plugin is Stale.",
						MarkdownDescription: "When a plugin registers with a certain heartbeatinterval and it does not meet that contract, Connect will assume\nthat the plugin is Stale / non-responsive. An alarm is raised when the plugin is Stale.",
					},
				},
				...
				Optional:            true,
				Computed:            true,
				Description:         "ConnectPluginStatus defines the observed state of ConnectPlugin.",
				MarkdownDescription: "ConnectPluginStatus defines the observed state of ConnectPlugin.",
			},
		},
	}
}

type ConnectPluginModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	pluginTypeAttribute, ok := attributes["plugin_type"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`plugin_type is missing from object`)

		return nil, diags
	}

	pluginTypeVal, ok := pluginTypeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`plugin_type expected to be basetypes.StringValue, was: %T`, pluginTypeAttribute))
	}

	requiredPluginsAttribute, ok := attributes["required_plugins"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`required_plugins is missing from object`)

		return nil, diags
	}

	requiredPluginsVal, ok := requiredPluginsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`required_plugins expected to be basetypes.ListValue, was: %T`, requiredPluginsAttribute))
	}

	supportedActionablesAttribute, ok := attributes["supported_actionables"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`supported_actionables is missing from object`)

		return nil, diags
	}

	supportedActionablesVal, ok := supportedActionablesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`supported_actionables expected to be basetypes.ListValue, was: %T`, supportedActionablesAttribute))
	}
	...
	return SpecValue{
		...
		Name:                 nameVal,
		PluginType:           pluginTypeVal,
		RequiredPlugins:      requiredPluginsVal,
		SupportedActionables: supportedActionablesVal,
		state:                attr.ValueStateKnown,
	}, diags
}
...
type SpecValue struct {
	...
	Name                 basetypes.StringValue `tfsdk:"name"`
	PluginType           basetypes.StringValue `tfsdk:"plugin_type"`
	RequiredPlugins      basetypes.ListValue   `tfsdk:"required_plugins"`
	SupportedActionables basetypes.ListValue   `tfsdk:"supported_actionables"`
	state                attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["plugin_type"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["required_plugins"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	attrTypes["supported_actionables"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.PluginType.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["plugin_type"] = val

		val, err = v.RequiredPlugins.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["required_plugins"] = val

		val, err = v.SupportedActionables.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["supported_actionables"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var requiredPluginsVal basetypes.ListValue
	switch {
	case v.RequiredPlugins.IsUnknown():
		requiredPluginsVal = types.ListUnknown(types.StringType)
	case v.RequiredPlugins.IsNull():
		requiredPluginsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		requiredPluginsVal, d = types.ListValue(types.StringType, v.RequiredPlugins.Elements())
		diags.Append(d...)
	}
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"name":               basetypes.StringType{},
			"plugin_type":        basetypes.StringType{},
			"required_plugins": basetypes.ListType{
				ElemType: types.StringType,
			},
			"supported_actionables": basetypes.ListType{
				ElemType: types.StringType,
			},
		}), diags
	}

	var supportedActionablesVal basetypes.ListValue
	switch {
	case v.SupportedActionables.IsUnknown():
		supportedActionablesVal = types.ListUnknown(types.StringType)
	case v.SupportedActionables.IsNull():
		supportedActionablesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		supportedActionablesVal, d = types.ListValue(types.StringType, v.SupportedActionables.Elements())
		diags.Append(d...)
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"required_plugins":      requiredPluginsVal,
			"supported_actionables": supportedActionablesVal,
		})
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.PluginType.Equal(other.PluginType) {
		return false
	}

	if !v.RequiredPlugins.Equal(other.RequiredPlugins) {
		return false
	}

	if !v.SupportedActionables.Equal(other.SupportedActionables) {
		return false
	}
...
func (t StatusType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	staleVal, ok := staleAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`stale expected to be basetypes.BoolValue, was: %T`, staleAttribute))
	}
...
type StatusValue struct {
	Stale basetypes.BoolValue `tfsdk:"stale"`
	state attr.ValueState
}
...
func (v StatusValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["stale"] = basetypes.BoolType{}.TerraformType(ctx)
